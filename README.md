...
```
I have gone through the whole intro section in this document. And delved further into each point. By contrast, it becomes apparent that my intention of providing a simple entry point in the public facing intro section, is in fact on point. Any part of the front facing part of the repository should be a simplified version of what is reflected upon in further detail and nuance in lower layer sub-documents and/or other repositories, recursively increasing the level of detail, understanding and depth. Giving anyone a chance to opt out before they delve too deep down the rabbit hole. Where things might actually start becoming more wild and unexpected 😼
